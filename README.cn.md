...
合计: **8,669** 行代码（覆盖前 5 种语言、共 **32** 个文件）。
...
- **Star**: 8,672 · **Fork**: 382 · **开放 issue**: 393 · **贡献者**: 73

## 累计统计

- **发布数**: 26 · **已合并 PR**: 141 · **开放 PR**: 43 · **已关闭 issue**: 240 · **开放 issue**: 153 · **提交数**: 717
...
在 [repology.org](https://repology.org/project/bubblewrap) 上共有 **220** 个发行版报告此项目。**63** 个 ✅ 已是最新上游版本，**134** 个 ⚠️ 使用旧版本。

| 发行版 | 版本 | 状态 |
|--------|------|------|
| Debian unstable | `0.12.0` | ✅ latest |
| Debian 14 | `0.12.0` | ✅ latest |
| Debian 13 | `0.11.0` | 🪦 legacy |
...
_数据快照: `data/card/260910.yml` · 2026-09-10T22:57:40Z._
